...
static struct FeatureDesc {
  ...
  F_I(MAXWATCHS, 0, 128, set_isupport_maxwatchs),
...
#if defined(USE_SSL)
  F_S(SSL_PEM_PATH, FEAT_CASE | FEAT_MYOPER | FEAT_READ, "ircd.pem", 0),
#endif
#if defined(DDB)
  ...
  /* Networking features */
#if defined(USE_ZLIB)
  F_I(ZLIB_CMPRS_SERVER, 0, 9, 0),
  F_I(ZLIB_CMPRS_CLIENT, 0, 6, 0),
#endif
...
#if defined(DDB)
  F_A(HIS_STATS_b, HIS_STATS_DDB),
  F_B(HIS_STATS_DDB, 0, 1, 0),
#endif
  ...
  F_A(HIS_STATS_E, HIS_STATS_ELINES),
  F_B(HIS_STATS_ELINES, 0, 1, 0),
  ...
  F_S(HIS_SERVERNAME, 0, "*.irc-dev.net", feature_notify_servername),
  F_S(HIS_SERVERINFO, 0, "IRC-Dev, Desarrollo de IRC / IRC Development", feature_notify_serverinfo),
  F_S(HIS_URLSERVERS, 0, "http://www.irc-dev.net/servers.php", 0),

  /* Misc. random stuff */
  F_S(NETWORK, 0, "IRC-Dev", set_isupport_network),
  F_S(URL_CLIENTS, 0, "ftp://ftp.irc.org/pub/irc/clients", 0),
