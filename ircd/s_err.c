...
/* 014 */
  { 0 },
/* 015 */
  { RPL_MAP, ":%s%s%s %s [%u client%s - %u.%u%%]", "015" },
/* 016 */
...
/* 247 */
  { RPL_STATSGLINE, "%c %s%s%s %Tu %c :%s (expires at %s)", "247" },
/* 248 */
  { RPL_STATSULINE, "U %s", "248" },
/* 249 */
  { RPL_STATSDEBUG, 0, "249" },
/* 250 */
  { RPL_STATSCONN, ":Highest connection count: %u (%u clients) (%u connections received)", "250" },
/* 251 */
  { RPL_LUSERCLIENT, ":There are %u users and %u invisible on %u servers", "251" },
/* 252 */
  { RPL_LUSEROP, "%u :operator(s) and %u official bot(s) online", "252" },
/* 253 */
...
/* 279 */
  { 0 },
/* 280 */
  { RPL_GLIST, "%s%s%s %Tu %s %c :%s (expires at %s)", "280" },
/* 281 */
...
/* 342 */
  { RPL_MSGONLYREG, "%s :Solo admite privados de usuarios registrados", "342" },
/* 343 */
  { 0 },
/* 344 */
  { 0 },
...
/* 490 */
  { ERR_NOOPERCLASS, ":Class %d non-existent", "490" },
/* 491 */
  { ERR_NOOPERHOST, ":No Operator block for your host", "491" },
/* 492 */
  { ERR_OPERCLASSFULL, ":Class %d is full!", "492" },
/* 493 */
