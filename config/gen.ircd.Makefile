...
sed -e "s:^CC=.*:CC=$CC:" \
    ...
    -e "s:^CPPFLAGS=.*:CPPFLAGS=$CPPFLAGS -I../libevent:" \
    -e "s:^LDFLAGS=.*:LDFLAGS=$LDFLAGS -lz -lpcre -L../libevent/.libs -levent:" \
    ...
    -e "s:^INCLUDEFLAGS=.*:INCLUDEFLAGS=$INCLUDEFLAGS -I../libevent:" \
