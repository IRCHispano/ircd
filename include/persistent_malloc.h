...
#if !defined(PERSISTENT_MALLOC_270_H)
#define PERSISTENT_MALLOC_270_H
...
/*
  ...
  set to zero.
*/
  void *persistent_calloc(size_t, size_t);
...
*/
  ...
  void *persistent_realloc(void *, size_t);
...
*/
  ...
  void *persistent_memalign(size_t, size_t);
...
*/
  ...
  void *persistent_dlvalloc(size_t);
...
*/
  ...
  void **persistent_independent_calloc(size_t, size_t, void **);
...
*/
  ...
  void **persistent_independent_comalloc(size_t, size_t *, void **);
 ...
 */
  ...
  void *persistent_pvalloc(size_t);
...
*/
  ...
  int persistent_malloc_trim(size_t);
...
*/
  ...
  size_t persistent_malloc_usable_size(void *);
...
*/
  ...
  struct persistent_mallinfo persistent_mallinfo(void);
...
*/
  ...
  int persistent_mallopt(int, int);
